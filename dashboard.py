...
class Dashboard:
    ...
    def initUI(self, db):
        ...
        self.add_button = Button(self.root, width=20, bg="blue", fg="white", text="Add New Note>>", font=self.Font,
                                 command=lambda: self.add_callback())
        self.add_button.place(x=20, y=20)
        self.list_all_btn = Button(self.root, width=20, bg="blue", fg="white", text="List All Notes", font=self.Font,
        ...
        self.search_button = Button(self.root, bg="blue", fg="white", text="Search", font=self.Font_search_btn, width=13,
